    ...
    border-b border-gray-200 font-sans'>
      <div className="flex items-center justify-between px-4 py-3 md:px-6 max-w-7xl mx-auto ">
        ...
        >
         ...
         bg-gradient-to-br from-fuchsia-500 via-purple-500 to-indigo-500 shadow-lg group-hover:shadow-purple-300/50
        ...
        <span className='text-2xl font-extrabold bg-gradient-to-r from-fuchsia-500 via-purple-500 to-indigo-500 bg-clip-text
        ...
        <div className='flex items-center gap-4'>
         ...
         hover:bg-purple-50 rounded-full'onClick={()=>navigate('/profile')}>
         ...
         <div ref={menuref} className='relative'>
          ...
          duration-300 border border-transparent hover:border-purple-200'>
            <div className='relative'>
              {user.avator ? (
                <img src={user.avator} alt="Avator" className='w-9 h-9 rounded-full shadow-sm'/>
            ...
            duration-300 ${menuOpen ? 'rotate-180':""}`}/>
          </button>
           {menuOpen && (
            <ul className="absolute top-14 right-0 w-56 bg-white
            rounded-2xl shadow-xl border border-purple-100 z-50 overflow-hidden animate-fadeIn ">
              <li className="p-2">
                <button onClick={()=>{
                  setMenuOpen(false)
                  navigate('/profile')
                }} className='w-full px-4 py-2.5 text-left 
                hover:bg-purple-50 text-sm text-gray-700
