...
import { HomeIcon,Plus,Filter, Calendar, CalendarIcon } from 'lucide-react'
    ...
    <div className={WRAPPER}>
      <div className={HEADER}>
        <div className="min-w-0">
          ...
          text-gray-800 items-center gap-2">
              <HomeIcon className='text-purple-500 w-5 h-5
              md:w-6 md:h-6 shrink-0'/>
      ...
      {/* CONTENTS */}
             <div className="space-y-6">
                 ...
                 <div className='space-y-4'>
                      {filteredTasks.length===0 ? (
                        ...
                        <div className={EMPTY_STATE.iconWrapper}>
                           ...
                           <h3 className="text-lg font-semi-bold text-gray-800 mb-2">
                            No task found
                           </h3>
                           <p className="text-sm text-gray-500 mb-4">
                            {filter==="all" ? "Create your first task to get started":"No tasks match for this filter"}
                           </p>
                ...
                <div 
                    ...
                    className="hidden md:flex items-center justify-center p-4 border border-dashed border-purple-200
